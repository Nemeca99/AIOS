        ...
        try:
            ...
            if hasattr(self, 'carma_system'):
                try:
                    ...
                    # EMBEDDER DECISION LOGIC: ALL QUESTIONS GO TO MAIN MODEL
                    # NO HARDCODED RESPONSES - ALL GENERATED BY ACTUAL MODELS
                    
                    # Force all questions to use main model for real responses
                    embedder_can_answer = False
                    
                    print(f"   MODEL DECISION: All questions routed to main model for real responses")
            ...
            # This ensures all responses are generated by actual models
