...
\"\"\"""",
        ...
        forbidden_patterns=[
            ...
            r"TODO|FIXME|HACK",  # No TODO comments in production
        ],
        required_patterns=[
...
class AIOSFileValidator:
    ...
    def _validate_python_file(self, file_path: Path, content: str, lines: List[str], standard: FileStandard) -> List[ValidationIssue]:
        ...
        if "from utils.unicode_safe_output import setup_unicode_safe_output" not in content:
            issues.append(ValidationIssue(
                file_path=str(file_path),
                line_number=0,
                column=0,
        ...
        for issue in result.issues:
            ...
            if issue.issue_type == "missing_shebang" and file_path.suffix == '.py':
                ...
                if "from utils.unicode_safe_output import setup_unicode_safe_output" not in content:
                    ...
                    lines.insert(insert_line + 5, "from utils.unicode_safe_output import setup_unicode_safe_output")
